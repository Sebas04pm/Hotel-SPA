...
const Login = () => {
  ...
  return (
    <>
      ...
      <div className='flex justify-center items-center h-[80vh]  bg-cover bg-servicios-Img'>
        <Card color='transparent' shadow={false} className='bg-backOscuro p-4'>
          <Typography
            variant='h4'
            color='blue-gray'
          ...
          <Typography color='white' className='mt-1 font-workSans '>
          ...
          <form className='mt-8 mb-2 w-80 max-w-screen-lg sm:w-96'>
            <div className='mb-4 flex flex-col gap-6'>
              <Input
                size='lg'
                label='Usuario'
                className='font-workSans bg-white'
                value={usuario}
            ...
            <div className='flex justify-center'>
              <Button
                className='mt-6 bg-white text-backOscuro font-bold w-3/5'
                onClick={handleLogin}
              >
                Ingresar
              </Button>
